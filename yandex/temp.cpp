...
vector<string> 
SplitIntoWordsNoStop  ( const     string&  text, 
...
void 
AddDocument  ( vector<vector<string>>  &documents,
                   const set<string>   &stop_words,
                   const     string    &document )
{
        ...
        documents.push_back( words );
                                                 ...
                                                 // Разбирает text на слова и возвращает только 
                                                 // те из них, которые не входят в stop_words
set<string> 
              ...
              const set<string> &stop_words) 
{
        ...
        return  query_words;
                                                 ...
                                                 // Возвращает true, если среди слов документа 
                                                 // (document_words) встречаются слова 
                                                 // поискового запроса query_words
bool 
MatchDocument  ( const vector<string>  &document_words,  
        ...
        return false;
                                                 ...
                                                 // Возвращает массив id документов, подходящих 
                                                 // под запрос query Стоп-слова исключаются из поиска
vector<int> 
FindDocuments  ( const vector<vector<string>>  &documents, 
                 const    set<string>  &stop_words,
                 const        string   &query) 
{
